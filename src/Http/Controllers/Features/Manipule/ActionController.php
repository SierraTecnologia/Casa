...
class ActionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'siravel::features.manipule.actions.index',
    ...
    public function executeAction($modelId, $actionCod)
    {
        ...
        return view(
            'siravel::features.manipule.actions.execute',
            compact(
                'runner'
            )
        );
    ...
    {
        return view('siravel::features.manipule.actions.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('siravel::features.manipule.actions.show', compact('gateway'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('siravel::features.manipule.actions.edit', compact('gateway'));
    }
